...
public class FilesController {
    ...
    public ResponseEntity<org.springframework.core.io.Resource> get(@PathVariable("fileName") String filename) throws IOException {
        ...
        if (file.exists() && !file.isDirectory()) {
            ...
            return ResponseEntity.ok().header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"" + resource.getFilename() + "\"").contentType(MediaType.APPLICATION_OCTET_STREAM) // can set to accurate file type based on MediaType
